...
class Instance:
    ...
    def best_results(self):
        ...
        query = 'SELECT instance_id, method_id, best, seed from iteration where instance_id = {} And method_id in {} and num_iteration={} order by instance_id'.format(self.instances_id[0], self.methods_id, max_iter)
